class Gpa(object):
    ...
    def getCourse(self):
        ...
        self.arg1 = input("Number of courses you have registered: " )
        pass
    ...
    def getScale(self):
        ...
        self.Scale = input("Pick a Scale value(Either 5 or 10): " )
        pass
        
        
    def getSubjectData(self):
        "get the subject Data in string"
        self.subData = raw_input("Enter your Grade: " ) 
        pass              
    ...
    def gpa(self):
        ...
        if self.Scale == 5 or self.Scale == 10:
            ...
            if self.arg1 >= 2:
                ...
                print "To calculate your Gpa, you schould have at least 2 subject at the minimum"
        else:
            print "incorrect scale entry please!"
        pass
    ...
    def cgpa(self):
        ...
        if self.Scale == 5 or self.Scale == 10:
            ...
            print "total registered credits:"+" "+str(tempTotalCredits)+" "+"and you have managed a CGPA of:\""+str(cgpa)+"\" "    
        else:
            print "incorrect scale input please"
        pass
